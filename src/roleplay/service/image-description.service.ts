    ...
    return {
      ...
      properties: {
        ...
        explanation: {
          type: Type.STRING,
          description:
            "If the image contains any important non-background text in a language other than English, use the given persona description to explain the image. Annotate all non-background text on the image, without skipping or summarizing parts. If there is no such text, leave this field empty.",
          example:
